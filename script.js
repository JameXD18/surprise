...
const getRandomNumber = (num) => {return Math.floor(Math.random() * (num + 1));};
  ...
  yesButton.addEventListener("click", () => {
    ...
    valentineQuestion.innerHTML = `
      <img src="./images/ducks.jpg" alt="Celebration duckie" style="display: block; margin: 0 auto; width: 200px; height: auto;"/>
      Congratulations!!<br>
      <span style="font-size: 20px; color: #bd1e59;">You have secured a Smurf for Valentine's Dayyy! <3</span>
    `;
